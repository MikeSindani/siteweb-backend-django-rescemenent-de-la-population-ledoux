...
def stats_home_section(request):
      nombre_population_total = Personnes.objects.all().count()
      nombre_migration = Personnes.objects.filter(nationalite__icontains='CONGO').count()
      ...
      pauvrete__emploi =  Personnes.objects.filter(Q(activite__icontains="Travailleur salari")).count()

      lire_et_comprendre = Personnes.objects.filter(comprendreLire__icontains='facile').count()
      lire_et_comprendre__non = Personnes.objects.exclude(comprendreLire__icontains='facile').count()
      lire_et_comprendre_homme_oui = Personnes.objects.filter(comprendreLire__icontains="facile",sexe='M').count()
      lire_et_comprendre_homme_non = Personnes.objects.filter(~Q(comprendreLire__icontains="facile") & Q(sexe='M')).count()
      lire_et_comprendre_femme_oui = Personnes.objects.filter(comprendreLire__icontains="facile",sexe='F').count()
      lire_et_comprendre_femme_non = Personnes.objects.filter(~Q(comprendreLire__icontains="facile") & Q(sexe='F')).count()
      #statistique generales pour les etat civil 
        
      nombre_etat_civil_marie = Personnes.objects.filter(etat_civil='Marié(e)').count()
      nombre_etat_civil_celibataire = Personnes.objects.filter(etat_civil__icontains='Jamais Marié(e)/Célibataire').count()
      nombre_etat_civil_separe = Personnes.objects.filter(etat_civil__icontains='Séparé').count()
      nombre_etat_civil_veuve = Personnes.objects.filter(etat_civil__icontains='Veuf').count()
      nombre_etat_civil_divorce = Personnes.objects.filter(etat_civil__icontains='Divorcé').count()
      ...
      Statistique__nationaux = Personnes.objects.filter(Q(nationalite__icontains="CONGO")).count()
      Statistique__etrangere = Personnes.objects.filter(~Q(nationalite__icontains="CONGO")).count()
      ...
      Taille__moyens__des__menages =  menager.objects.aggregate(Avg('nombre_ocupant')) #Personnes.objects.all().count() / menager.objects.all().count()
      ...
      Statistique__by__aera__travail__non  = Personnes.objects.filter(Q(activite__icontains="Travailleur non salari")).count() 
      ...
      Statistique__by__aera__agricole  = Personnes.objects.filter(Q(activite__icontains="Travailleur agricole")).count() 
      ...
      context = {
                 ...
                 "pauvrete__emploi":pauvrete__emploi,
                  ...
                  "Statistique__by__aera__agricole":Statistique__by__aera__agricole,
...
def get__resencement__population__stats_section(request,commune,categorie):
      ...
      if categorie == "Migration":
            stat__population__total = Personnes.objects.filter(commune=commune).count()
            Statistique__by__aera__nationaux = Personnes.objects.filter(Q(nationalite__icontains="CONGO") & Q(commune=commune)).count()
            Statistique__by__aera__etrangere = Personnes.objects.filter(~Q(nationalite__icontains="CONGO") & Q(commune=commune)).count()
      ...
      if categorie == "Etat-Civil":
              ...
              stat__population__total = Personnes.objects.filter(commune=commune).count()
              Statistique__by__aera__Celibataire = Personnes.objects.filter(Q(etat_civil__icontains="Jamais Marié(e)/Célibataire") & Q(commune=commune)).count()
              Statistique__by__aera__Marie = Personnes.objects.filter(Q(etat_civil__contains="Marié(e)") & Q(commune=commune)).count()
              ...
              Statistique__by__aera__Separe = Personnes.objects.filter(Q(etat_civil__icontains="Séparé") & Q(commune=commune)).count()
      ...
      if categorie == "Pauvrete":
                        ...
                        Statistique__by__aera__chomeur  = Personnes.objects.filter(Q(activite__icontains="chomeur")).count() 
                        Statistique__by__aera__agricole  = Personnes.objects.filter(Q(activite__icontains="Travailleur agricole")).count()
                        Statistique__by__aera__etudiant  = Personnes.objects.filter(Q(activite__icontains="Etudiant")).count()
                        Statistique__by__aera__menagere  = Personnes.objects.filter(Q(activite__icontains="Ménagère")).count()
                        Statistique__by__aera__enfant__non__scolarise  = Personnes.objects.filter(Q(activite__icontains="Enfant non scolarisé")).count()
                        context = { 
                        "stat__population__total":stat__population__total,
                        "Statistique__by__aera__travail__oui":Statistique__by__aera__travail__oui,
                        'Statistique__by__aera__travail__non':Statistique__by__aera__travail__non, 
                        ...
                        "Statistique__by__aera__chomeur":Statistique__by__aera__chomeur, 
                        "Statistique__by__aera__agricole":Statistique__by__aera__agricole,
                        "Statistique__by__aera__etudiant":Statistique__by__aera__etudiant,
                        "Statistique__by__aera__menagere":Statistique__by__aera__menagere,
                        "Statistique__by__aera__enfant__non__scolarise":Statistique__by__aera__enfant__non__scolarise
...
def get__statistique__otherwise__quartier(request,categorie,commune):
      ...
      if categorie == "Migration":
            ...
            for i in  list__of__quartier:
              Statistique__by__aera = Personnes.objects.filter(quartier=i).count()
              Statistique__by__aera__nationaux = Personnes.objects.filter(Q(nationalite__icontains="CONGO") & Q(quartier=i)).count()
              Statistique__by__aera__etrangere = Personnes.objects.filter(~Q(nationalite__icontains="CONGO") & Q(quartier=i)).count()
              tup = {'Statistique__by__aera':Statistique__by__aera,
                     'name__aera':i,
                  "Statistique__by__aera__nationaux":Statistique__by__aera__nationaux,
                  "Statistique__by__aera__etrangere":Statistique__by__aera__etrangere}
      ...
      if categorie == "Etat-Civil":
            ...
            for i in  list__of__quartier:
              Statistique__by__aera = Personnes.objects.filter(quartier=i).count()
              Statistique__by__aera__Celibataire = Personnes.objects.filter(Q(etat_civil__icontains="Jamais Marié(e)/Célibataire") & Q(quartier=i)).count()
              Statistique__by__aera__Marié = Personnes.objects.filter(Q(etat_civil__contains="Marié(e)") & Q(quartier=i)).count()
              ...
              Statistique__by__aera__Separé = Personnes.objects.filter(Q(etat_civil__icontains="Séparé") & Q(quartier=i)).count()
      ...
      if categorie == "Pauvrete":
            ...
            for i in  list__of__quartier:
              Statistique__by__aera = Personnes.objects.filter(quartier=i).count()
              Statistique__by__aera__travail__oui  = Personnes.objects.filter(Q(activite__icontains="Travailleur salari")& Q(quartier=i)).count()
              Statistique__by__aera__travail__non  = Personnes.objects.filter(Q(activite__icontains="Travailleur non salari")& Q(quartier=i)).count()
              Statistique__by__aera__Retraite  = Personnes.objects.filter(Q(activite__icontains="retrait")& Q(quartier=i)).count()
              Statistique__by__aera__chomeur  = Personnes.objects.filter(Q(activite__icontains="chomeur")& Q(quartier=i)).count() 
              Statistique__by__aera__agricole  = Personnes.objects.filter(Q(activite__icontains="Travailleur agricole")& Q(quartier=i)).count()
              Statistique__by__aera__etudiant  = Personnes.objects.filter(Q(activite__icontains="Etudiant")& Q(quartier=i)).count()
              Statistique__by__aera__menagere  = Personnes.objects.filter(Q(activite__icontains="Ménagère")& Q(quartier=i)).count()
              Statistique__by__aera__enfant__non__scolarise  = Personnes.objects.filter(Q(activite__icontains="Enfant non scolarisé")& Q(quartier=i)).count()
                       
              tup = {
                     'Statistique__by__aera':Statistique__by__aera,
                     'name__aera':i,
                       "Statistique__by__aera__travail__oui":Statistique__by__aera__travail__oui,
                        'Statistique__by__aera__travail__non':Statistique__by__aera__travail__non, 
                        "Statistique__by__aera__Retraite":Statistique__by__aera__Retraite,
