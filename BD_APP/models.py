...
class Personnes(models.Model):
    ...
    zones = models.ForeignKey("Zones",related_name='Zones',null=True,on_delete=models.CASCADE)

    def __str__(self):
       return "{} {}".format(self.nom, self.prenom)
   
class Zones(models.Model):
    agent_codificateur = models.ForeignKey(UserAgent,related_name='agent_codificateur',null=True,on_delete=models.CASCADE)
    agent_controleur = models.ForeignKey(UserAgent,related_name='agent_controleur',null=True,on_delete=models.CASCADE)
    agent_rescenseur = models.ForeignKey(UserAgent,related_name='agent_rescenseur',null=True,on_delete=models.CASCADE)
